...
<img width="1141" height="792" alt="Screenshot 2026-08-23 191408" src="https://github.com/user-attachments/assets/f2d8e0db-018f-406c-8014-92ac661beae4" />
...
<details>
  <summary>Click here see example</summary>
	
<img width="1141" height="792" alt="Screenshot 2026-08-23 191408" src="https://github.com/user-attachments/assets/f2d8e0db-018f-406c-8014-92ac661beae4" />

This is an example using the rock tower from my Quackpack Parallax Continued Mod, placing it on Kerbins shores as a custom ROC. I've included an example for now that takes a `.mu` from my `Kerbin Heavy Industries` mod, and makes it a surface feature.
...
I highly recommend using the debug menu to place these points, to make sure that they are reachable by a normal craft. It's in the cheat menu (Alt+F12), Breaking ground, scan features.

<img width="1782" height="753" alt="Screenshot 2026-08-22 170545" src="https://github.com/user-attachments/assets/951fc402-dde4-4003-9e37-0486138f540a" />

Points will show up as blue crosses like the following:

<img width="1945" height="1032" alt="Screenshot 2026-08-22 202735" src="https://github.com/user-attachments/assets/6e31e492-e143-4ca5-8427-7d9e65f636e8" />
...
<img width="1141" height="792" alt="Screenshot 2026-08-23 191408" src="https://github.com/user-attachments/assets/08669497-1b66-4cac-a43d-c76bae155b8e" />
</details>

## License

Code and configs are licensed under the [CC BY-NC-SA](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.en).
All textures/models are ARR.
